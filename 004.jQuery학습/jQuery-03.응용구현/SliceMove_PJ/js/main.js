...
$(function () { /// jQB //////////////////
    ...
    // 2. 인트로 셋팅: 1초 후 flex와 transition을 적용한다!
    ...
    $("#ham").click(function () {
        ...
        //// 닫기 버튼 이미지 넣기 //////
        $("body").append('<img src="images/OB/close_.png" alt="닫기버튼" id="cbtn">');
        ...
        cvbx.hover(
            ...
            .mousemove(function (e) { // e-이벤트전달변수
                ...
                let posx = e.pageX + 5;
                let posy = e.pageY + 5;
                // 5를 더한 이유는 닫기이미지가 커서아래에 오지 않게
                // 하여 .cvbx에 오버시 깜박거리는 현상을 없앤다!
