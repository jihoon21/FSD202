    ...
    */
    ...
    $(document).on("mousewheel DOMMouseScroll", function (e) {
        ...
        */
        ...
        let pgpos = winH * pno;
        // 이렇게 하는 이유? 페이지 위치값이 구해졌지만 이동시 sync문제(일치)로 값이 잘 반영되지 않을때 원페이지의 위치 이동을 이렇게 계산해서 이동함!
